<template>
    <div class="card">
        ...
        <div class="card-header" v-if="modoDetalle">
            <div class="row">
                <div class="col-9">
                    <b>DETALLE DE TRANSACCIÓN DE VENTA</b>
                </div>
...
export default {
  data() {
    ...
    offset: 1,
      //MODEL_ATTR
      model: {Fecha: '', FechaESP: '', idTransaccion: '', Estado: '', NTP: '', idTipoPago: '', idVendedor: '', NVend: '', idProveedor: ''},
  ...
  methods:{
    ...
    insertModel(page){
      ...
      this.model = {Fecha: '', FechaESP: '', idTransaccion: '', Estado: '', NTP: '', idTipoPago: '', idVendedor: '', NVend: '', idProveedor: ''};
    ...
    updateModel(model){
      ...
      //MODEL_ATTR
      const params = {Fecha: model.Fecha, Estado: model.Estado, idTipoPago: model.idTipoPago, idVendedor: model.idVendedor, idProveedor: model.idCliente};
