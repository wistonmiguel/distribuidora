...
export default {
  data() {
    ...
    offset: 1,
      //MODEL_ATTR
      model: {Fecha: '', FechaESP: '', idTransaccion: '', Factura: '', Estado: '', NCli: '', idCliente: '', NVend: '', idVendedor: ''},
  ...
  methods:{
    ...
    viewDetails(item){
        //MODEL_ATTR
        this.model = {Fecha: '', FechaESP: '', idTransaccion: '', Factura: '', Estado: '', NCli: '', idCliente: '', NVend: '', idVendedor: ''};
